...
class srl_labeler():
    ...
    def annoatate_txt(self, seg_file, batch, index_a, index_b, index_label, has_b, is_test=False):
        print(index_a, index_b, index_label, has_b)
        with open(seg_file, 'r', encoding='utf-8') as data_file, open(seg_file + "_tag", 'w', encoding='utf-8') as new_file:
